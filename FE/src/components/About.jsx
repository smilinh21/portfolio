        ...
        <div name='About' className=' pt-8 h-full min-h-screen w-full flex items-center  bg-gradient-to-b to-black via-black from-gray-800 '>
            <div className='section justify-between'>
                ...
                <div className='mb-10  flex flex-col justify-center '>
                    <img src={profile} alt="Profile" width="auto" height="auto" loading='lazy' title='Profile Picture' className='cursor-pointer hover:grayscale-0 hover:scale-[1.02] transition-all delay-75 border-4 border-transparent duration-300 rounded-2xl min-w-[240px] w-1/2 mx-auto  md:w-[270px]' />
                </div>
                <div className='flex flex-col justify-center w-full px-2 xs: sm:px-12 md:px-4 lg:px-14 text-white '>
                    <h3 className='text-2xl xs:text-3xl  sm:text-4xl md:text-5xl lg:text-6xl font-semibold '>Hi, I'm <span className='text-pink-500 block xs:inline'>Kate Le</span></h3>
                    <div className='text-gray-400 py-4 space-y-2 md:space-y-2 md:pt-8 lg:pt-12 font-semibold text-justify'>
                        <p className='leading-tight'>
                            An aspiring Fullstack Web Developer based in Vietnam. 
                        </p>
                    </div>
                    ...
                    <div className='py-5'>
                        <a href={resume} target="_blank" rel="noreferrer" download={true} className='z-30  group bg-pink-400 flex items-center justify-center gap-3 px-6 py-3  rounded-lg ease-linear duration-300 delay-75 transition-all cursor-pointer w-36 relative'>
