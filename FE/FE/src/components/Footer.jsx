            ...
            <div className="section pb-5">
                <div className="flex flex-wrap justify-between ">
                    <div className="w-full sm:w-3/5 lg:w-2/5 pr-2">
                        <h3 className='text-white text-[1.75rem] font-bold pb-2'>Kate Le</h3>
                        <p className='text-lg text-pink-400 pb-5'>FullStack Developer</p>
                                ...
                                <div key={id} className="group w-fit px-3">
                                    <Link to={link} smooth duration={500}>
                                        <div className="flex items-center justify-between w-fit gap-2 font-semibold text-white cursor-pointer">
                                            <ArrowRightLong />
                                            <span className='bg-clip-text bg-pink-400 group-hover:text-transparent duration-500 group-hover:animate-pulse '>
                                                {link}
                                            </span>
                                        </div>
                                    </Link>
                        ...
                        <div className="flex flex-col sm:flex-row lg:flex-col  gap-5 xs:gap-10 sm:gap-5 md:gap-10 justify-between">
                            <div className='text-[0.9rem] font-advanced'>
                                <p className='flex items-center gap-3 mb-1'>
                                    <GMail /> lplinh0403@gmail.com</p>
                                <p className='flex items-center gap-3 '> <Map /><span className="pt-1">Hanoi, Vietnam</span></p>
                            </div>
