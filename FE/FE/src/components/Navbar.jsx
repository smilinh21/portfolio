...
const Navbar = () => {
    ...
    return (
        <>
            <div className='fixed w-full max-w-[100vw] h-20 bg-gradient-to-b from-pink via-pink to-transparent z-50 bg-opacity-[0.9]'>
                <div className='flex justify-between items-center px-5 max-w-screen-2xl mx-auto'>

                    <div>
                        <img src={logo} alt="logo" className='h-32 object-contain object-center'/>
                    </div>
