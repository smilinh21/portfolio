...
import SendFormData from '../../api/formData'
            ...
            <div className='section'>
                ...
                <div className='flex justify-center items-center'>
                    <form onSubmit={handleSubmit} className='flex gap-3 flex-col w-full md:w-1/2 '>
                        ...
                        <button className='hover:text-blue-800 flex items-center justify-center mr-auto group text-white bg-pink-400 rounded-md font-semibold px-12 py-2 hover:scale-[1.02] duration-500'>Let's Connect
