...
const Home = () => {
    const work = ['Frontend Development', 2000, 'Backend Development', 2000, 'UI/UX Designing', 2000]
        ...
        <div name='Home' className='pt-8 h-full min-h-screen w-full flex items-center bg-gradient-to-b from-black via-black to-gray-800 '>
            <div className='section gap-16 md:gap-1 md:justify-between items-center md:flex-row-reverse'>
                <div className='flex flex-col justify-center md:w-2/5 max-w-[320px]'>
                    <img src={Avatar} alt="" width="auto" height="auto" loading='eager' title='Avatar' className='rounded-3xl mx-auto w-full shadow-2xl' />
                </div>
                <div className='pl-2 xs:pl-8 flex flex-col gap-3 justify-center text-gray-200 w-max md:w-3/5'>
                    <h1 className='text-5xl xs:text-6xl lg:text-7xl font-bold '>
                        ...
                        <span>I'm </span>
                        <span className='text-transparent bg-pink-400 bg-clip-text'> Kate </span>
                    </h1>
                    <p className='text-gray-400 text-xl xs:text-2xl font-semibold py-4 min-w-[16rem] xs:min-w-[25rem] max-w-[26rem]'>
                        ...
                        <span className='text-pink-400 xs:pl-2'>
                            <TypeAnimation
                                sequence={work}
                                speed={1}
                                wrapper="span"
                    ...
                    <div className='py-5'>
                        <Link to="About" smooth duration={500} className='z-30 group bg-pink-400 flex items-center justify-center gap-3 px-6 py-3  rounded-lg ease-linear duration-300 delay-75 transition-all cursor-pointer w-40 relative '>
